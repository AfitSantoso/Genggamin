...
/**
 * Controller untuk mengelola Plafond CRUD operations hanya bisa diakses oleh ADMIN View operations
...
public class PlafondController {
  ...
  /** Get all plafonds PUBLIC - Accessible without authentication */
  @GetMapping
  ...
  /** Get only active plafonds (isActive = true) PUBLIC - Accessible without authentication */
  @GetMapping("/active")
  ...
  /** Get plafond by ID PUBLIC - Accessible without authentication */
  @GetMapping("/{id}")
  ...
  /**
   * Get plafonds by income range PUBLIC - Accessible without authentication for checking
   * eligibility
   */
