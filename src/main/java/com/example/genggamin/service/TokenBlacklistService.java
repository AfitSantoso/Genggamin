...
/**
 * Service untuk mengelola blacklist JWT token menggunakan Redis Token yang di-blacklist akan
 * disimpan di Redis dengan TTL sesuai expiration time token
 */
@Service
public class TokenBlacklistService {
  ...
  public void clearAllBlacklist() {
    redisTemplate.keys(BLACKLIST_PREFIX + "*").forEach(key -> redisTemplate.delete(key));
  }
}
