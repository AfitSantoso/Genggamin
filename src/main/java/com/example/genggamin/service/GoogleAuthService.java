...
public class GoogleAuthService {
    ...
    public GoogleAuthService(GoogleIdTokenVerifier verifier, UserRepository userRepository, RoleRepository roleRepository, JwtUtil jwtUtil, PasswordEncoder passwordEncoder) {
    ...
    @Transactional
    public LoginResponse loginWithGoogle(String idTokenString, String fcmToken) throws GeneralSecurityException, IOException {
